 ...
 */
@WebServlet("/SchoolNewsServlet")
public class SchoolNewsServlet extends HttpServlet {
	...
	protected void initSQLTableName(){
		sqlTableName = "hongtai_school_news";
		urlPath = "http://www.nuc.edu.cn/ejlb.jsp?urltype=tree.TreeTempUrl&wbtreeid=1106";
	}
