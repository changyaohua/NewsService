 ...
 *x`
 */
public class InitNewsJiSuanJi {

	private static String urlPath = "http://csce.nuc.edu.cn/xs/xsdt.htm";
	private String urlNextPath = "http://csce.nuc.edu.cn/xs/xsdt";
	private String urlContentPath = "http://csce.nuc.edu.cn";
	private String currUrlPath;

	private static String sqlTableName = "hongtai_news_jisuanji";
	...
	public static void main(String[] args) {
		InitNewsJiSuanJi initSchoolJob = new InitNewsJiSuanJi();
